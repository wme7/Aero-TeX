...
do l = 1, nv 
	...
	do j = 1,ny    
           ...
           if  (x(i).le.1)then
            ...
            else if ((x(i).le.4) .or. (x(i).ge.6) .or. (y(j).le.4.75) .or. (y(j).ge.5.25)) then
                z(i,j) = z2
                ux(i,j)= ux2
                uy(i,j)= uy2
                t(i,j) = t2
				pp = ( (v(k)-ux(i,j))**2 + (v(l)-uy(i,j))**2 ) / t(i,j)
				f(k,l,i,j) = 1/((exp(pp)/z(i,j)) + theta)
			else if ((x(i).le.(4+dx)) .or. (x(i).ge.(6-dx)) .or. (y(j).le.(4.75+dy)) .or. (y(j).ge.(5.25-dy)))	then
				z(i,j) = zw
                ux(i,j)= uxw
                uy(i,j)= uyw
                t(i,j) = tw
...
do l = 1, nv	
	do i = 1, nx
	do j = 1, ny
		if  ((x(i).le.4) .or. (x(i).ge.6) .or. (y(j).le.4.75) .or. (y(j).ge.5.25)) then
...
! l part	   NEED TO BE CHANGED
	do i = 2,nx-1
	do j = 2,ny-1
		if ((x(i).le.4+dx).and.(x(i).ge.4-dx).and.(y(j).le.5.25+dy) .and. (y(j).ge.4.75-dy)) then
...
! b part   NEED TO BE CHANGED
	do i = 2,nx-1
	do j = 2,ny-1
		if ((y(j).le.4.75+dy).and.(y(j).ge.4.75-dy).and.(x(i).ge.4-dx).and.(x(i).le.6+dx)) then
	...
	do i = 2,nx-1
	do j = 2,ny-1	 	
		if ((y(j).le.4.75).and.(x(i).ge.4-dx).and.(x(i).le.6+dx)) then	 
        fll(i,j) = vxp*f(k,l,i-1,j)+vxm*f(k,l,i,j)
        flh(i,j) = 0.5d0*v(k)*(f(k,l,i-1,j)+f(k,l,i,j))-0.5d0*dtdx*v(k)**2*(f(k,l,i,j)-f(k,l,i-1,j)) 
        fl(i,j) = fll(i,j)+ (phia(i-1,j)*(flh(i,j)-fll(i,j)))
        fhl(i,j) = vxp*f(k,l,i,j)+vxm*f(k,l,i+1,j)
...
! t part	NEED TO BE CHANGED
	do i = 2,nx-1
	do j = 2,ny-1
		if ((y(j).ge.5.25-dy).and.(y(j).le.5.25+dy).and.(x(i).ge.4-dx).and.(x(i).le.6+dx)) then
	...
	do i = 2,nx-1
	do j = 2,ny-1	 	
		if ((y(j).ge.5.25).and.(x(i).ge.4.-dx).and.(x(i).le.6.+dx)) then	 
        fll(i,j) = vxp*f(k,l,i-1,j)+vxm*f(k,l,i,j)
        flh(i,j) = 0.5d0*v(k)*(f(k,l,i-1,j)+f(k,l,i,j))-0.5d0*dtdx*v(k)**2*(f(k,l,i,j)-f(k,l,i-1,j)) 
        fl(i,j) = fll(i,j)+ (phia(i-1,j)*(flh(i,j)-fll(i,j)))
        fhl(i,j) = vxp*f(k,l,i,j)+vxm*f(k,l,i+1,j)
...
! r part	 NEED TO BE CHANGED
	do i = 2,nx-1
	do j = 2,ny-1
		if ((x(i).ge.6.-dx).and.(x(i).le.6.+dx).and.(y(j).le.5.25+dy) .and. (y(j).ge.4.75-dy)) then
...
write(20,888)
write(20,*) 'zone t="left",i=',nx,',j=',floor((ny/(10/4.)))
do i = 1, nx
do j = 1, ny
   if ( x(i).le.4. ) then
...
write(20,*) 'zone t="right",i=',nx,',j=',floor(ny/(10/4.))
do i = 1, nx
do j = 1, ny
   if ( x(i).ge.6. ) then
   write (20,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
...
write(20,*) 'zone t="top",i=',floor(nx/(10/4.75)+1),',j=',floor(ny/5.+2)
do i = 1, nx
do j = 1, ny
   if (( x(i).ge.(4.-dx) ) .and. ( x(i).le.(6.+dx) ) .and. (y(j).ge.5.25)) then
   write (20,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
   end if
end do 
end do
write(20,*) 'zone t="bottom",i=',floor(nx/(10/4.75)+1),',j=',floor(ny/5.+2)
do i = 1, nx
do j = 1, ny
   if (( x(i).ge.(4.-dx) ) .and. ( x(i).le.(6.+dx) ) .and. (y(j).le.4.75)) then
   write (20,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
   end if
end do 
end do
...
write(25,888)
write(25,*) 'zone t="left",i=',nx,',j=',floor((ny/(10/4.)))
do i = 1, nx
do j = 1, ny
   if ( x(i).le.4. ) then
...
write(25,*) 'zone t="right",i=',nx,',j=',floor(ny/(10/4.))
do i = 1, nx
do j = 1, ny
   if ( x(i).ge.6. ) then
   write (25,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
...
write(25,*) 'zone t="top",i=',floor(nx/(10/4.75)+1),',j=',floor(ny/5.+2)
do i = 1, nx
do j = 1, ny
   if (( x(i).ge.(4.-dx) ) .and. ( x(i).le.(6.+dx) ) .and. (y(j).ge.5.25)) then
   write (25,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
...
write(25,*) 'zone t="bottom",i=',floor(nx/(10/4.75)+1),',j=',floor(ny/5.+2)
do i = 1, nx
do j = 1, ny
   if (( x(i).ge.(4.-dx) ) .and. ( x(i).le.(6.+dx) ) .and. (y(j).le.4.75)) then
   write (25,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
...
write(27,888)
write(27,*) 'zone t="left",i=',nx,',j=',floor((ny/(10/4.)))
do i = 1, nx
do j = 1, ny
   if ( x(i).le.4. ) then
...
write(27,*) 'zone t="right",i=',nx,',j=',floor(ny/(10/4.))
do i = 1, nx
do j = 1, ny
   if ( x(i).ge.6. ) then
   write (27,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
...
write(27,*) 'zone t="top",i=',floor(nx/(10/4.75)+1),',j=',floor(ny/5.+2)
do i = 1, nx
do j = 1, ny
   if (( x(i).ge.(4.-dx) ) .and. ( x(i).le.(6.+dx) ) .and. (y(j).ge.5.25)) then
   write (27,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
...
write(27,*) 'zone t="bottom",i=',floor(nx/(10/4.75)+1),',j=',floor(ny/5.+2)
do i = 1, nx
do j = 1, ny
   if (( x(i).ge.(4.-dx) ) .and. ( x(i).le.(6.+dx) ) .and. (y(j).le.4.75)) then
   write (27,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
...
write(30,888)
write(30,*) 'zone t="left",i=',nx,',j=',floor((ny/(10/4.)))
do i = 1, nx
do j = 1, ny
   if ( x(i).le.4. ) then
...
write(30,*) 'zone t="right",i=',nx,',j=',floor(ny/(10/4.))
do i = 1, nx
do j = 1, ny
   if ( x(i).ge.6. ) then
   write (30,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
...
write(30,*) 'zone t="top",i=',floor(nx/(10/4.75)+1),',j=',floor(ny/5.+2)
do i = 1, nx
do j = 1, ny
   if (( x(i).ge.(4.-dx) ) .and. ( x(i).le.(6.+dx) ) .and. (y(j).ge.5.25)) then
   write (30,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
...
write(30,*) 'zone t="bottom",i=',floor(nx/(10/4.75)+1),',j=',floor(ny/5.+2)
do i = 1, nx
do j = 1, ny
   if (( x(i).ge.(4.-dx) ) .and. ( x(i).le.(6.+dx) ) .and. (y(j).le.4.75)) then
   write (30,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
...
write(33,888)
write(33,*) 'zone t="left",i=',nx,',j=',floor((ny/(10/4.)))
do i = 1, nx
do j = 1, ny
   if ( x(i).le.4. ) then
...
write(33,*) 'zone t="right",i=',nx,',j=',floor(ny/(10/4.))
do i = 1, nx
do j = 1, ny
   if ( x(i).ge.6. ) then
   write (33,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
...
write(33,*) 'zone t="top",i=',floor(nx/(10/4.75)+1),',j=',floor(ny/5.+2)
do i = 1, nx
do j = 1, ny
   if (( x(i).ge.(4.-dx) ) .and. ( x(i).le.(6.+dx) ) .and. (y(j).ge.5.25)) then
   write (33,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
...
write(33,*) 'zone t="bottom",i=',floor(nx/(10/4.75)+1),',j=',floor(ny/5.+2)
do i = 1, nx
do j = 1, ny
   if (( x(i).ge.(4.-dx) ) .and. ( x(i).le.(6.+dx) ) .and. (y(j).le.4.75)) then
   write (33,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
...
write(35,888)
write(35,*) 'zone t="left",i=',nx,',j=',floor((ny/(10/4.)))
do i = 1, nx
do j = 1, ny
   if ( x(i).le.4. ) then
...
write(35,*) 'zone t="right",i=',nx,',j=',floor(ny/(10/4.))
do i = 1, nx
do j = 1, ny
   if ( x(i).ge.6. ) then
   write (35,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
...
write(35,*) 'zone t="top",i=',floor(nx/(10/4.75)+1),',j=',floor(ny/5.+2)
do i = 1, nx
do j = 1, ny
   if (( x(i).ge.(4.-dx) ) .and. ( x(i).le.(6.+dx) ) .and. (y(j).ge.5.25)) then
   write (35,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
...
write(35,*) 'zone t="bottom",i=',floor(nx/(10/4.75)+1),',j=',floor(ny/5.+2)
do i = 1, nx
do j = 1, ny
   if (( x(i).ge.(4.-dx) ) .and. ( x(i).le.(6.+dx) ) .and. (y(j).le.4.75)) then
   write (35,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
...
write(37,888)
write(37,*) 'zone t="left",i=',nx,',j=',floor((ny/(10/4.)))
do i = 1, nx
do j = 1, ny
   if ( x(i).le.4. ) then
...
write(37,*) 'zone t="right",i=',nx,',j=',floor(ny/(10/4.))
do i = 1, nx
do j = 1, ny
   if ( x(i).ge.6. ) then
   write (37,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
...
write(37,*) 'zone t="top",i=',floor(nx/(10/4.75)+1),',j=',floor(ny/5.+2)
do i = 1, nx
do j = 1, ny
   if (( x(i).ge.(4.-dx) ) .and. ( x(i).le.(6.+dx) ) .and. (y(j).ge.5.25)) then
   write (37,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
...
write(37,*) 'zone t="bottom",i=',floor(nx/(10/4.75)+1),',j=',floor(ny/5.+2)
do i = 1, nx
do j = 1, ny
   if (( x(i).ge.(4.-dx) ) .and. ( x(i).le.(6.+dx) ) .and. (y(j).le.4.75)) then
   write (37,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
...
!
write(40,888)
write(40,*) 'zone t="left",i=',nx,',j=',floor((ny/(10/4.)))
do i = 1, nx
do j = 1, ny
   if ( x(i).le.4. ) then
...
write(40,*) 'zone t="right",i=',nx,',j=',floor(ny/(10/4.))
do i = 1, nx
do j = 1, ny
   if ( x(i).ge.6. ) then
   write (40,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
...
write(40,*) 'zone t="top",i=',floor(nx/(10/4.75)+1),',j=',floor(ny/5.+2)
do i = 1, nx
do j = 1, ny
   if (( x(i).ge.(4.-dx) ) .and. ( x(i).le.(6.+dx) ) .and. (y(j).ge.5.25)) then
   write (40,*) x(i), y(j), r(i,j), p(i,j), z(i,j)
...
write(40,*) 'zone t="bottom",i=',floor(nx/(10/4.75)+1),',j=',floor(ny/5.+2)
do i = 1, nx
do j = 1, ny
   if (( x(i).ge.(4.-dx) ) .and. ( x(i).le.(6.+dx) ) .and. (y(j).le.4.75)) then
   write (40,*) x(i), y(j), r(i,j), p(i,j), z(i,j)

...
\begin{frame}
	\frametitle{Lax case}
		...
		\begin{figure}
			\centering
				\includegraphics[width=0.90\textwidth]{LAX_upwind_DDOM}
...
\begin{frame}
	\frametitle{Lax case}
		...
		\begin{figure}
			\centering
				\includegraphics[width=0.90\textwidth]{LAX_upwind_DDOM_2}
...
\begin{frame}
	\frametitle{Sjogreen case}
		...
		\begin{figure}
			\centering
				\includegraphics[width=0.90\textwidth]{Sjogreen_upwind_DDOM}
			\caption{Result using MB distribution, Upwind discretization for all space differentials with 100 points in physical space, DDOM with 3 velocity points in velocity space, and $\tau = {1 \over 10000}$}
...
\begin{frame}
	\frametitle{Sjogreen case}
		...
		\begin{figure}
			\centering
				\includegraphics[width=0.90\textwidth]{Sjogreen_upwind_DDOM_2}
			\caption{Result using MB distribution, Upwind discretization for all space differentials with 200 points in physical space, DDOM with 3 velocity points in velocity space, and $\tau = {1 \over 10000}$}
...
\begin{frame}
	\frametitle{Sod's case}
		...
		\begin{figure}
			\centering
				\includegraphics[width=0.90\textwidth]{Sods_upwind_DDOM}
			\caption{Result using MB distribution, Upwind discretization for all space differentials with 200 points in physical space, DDOM with 3 velocity points in velocity space and $\tau = {1 \over 10000}$}
...
\begin{frame}
	\frametitle{Sod's case}
		...
		\begin{figure}
			\centering
				\includegraphics[width=0.90\textwidth]{Sods_upwind_DDOM_2}
			\caption{Result using MB distribution, Upwind discretization for all space differentials with 200 points in physical space, DDOM with 3 velocity points in velocity space and $\tau = {1 \over 10000}$}
...
\begin{frame}
	\frametitle{Sod's case}
		...
		\begin{figure}
			\centering
				\includegraphics[width=0.90\textwidth]{Sods_upwind_DDOM_wfix}
			\caption{Result using MB distribution, Upwind discretization for all space differentials with 200 points in physical space, DDOM with 3 velocity points in velocity space and $\tau = {1 \over 10000}$}
...
\begin{frame}
	\frametitle{Sod's case}
		...
		\begin{figure}
			\centering
				\includegraphics[width=0.90\textwidth]{Sods_upwind_DDOM_wfix2}
			\caption{Result using MB distribution, Upwind discretization for all space differentials with 200 points in physical space, DDOM with 3 velocity points in velocity space and $\tau = {1 \over 10000}$}

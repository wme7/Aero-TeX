...
\begin{figure}
        ...
        \end{subfigure}%
          ...
          %(or a blank line to force the subfigure onto a new line)
				\begin{subfigure}[b]{0.49\textwidth}
                \centering
                \includegraphics[trim = 20mm 15mm 20mm 20mm,clip,width=\textwidth]{17ESBGK_MB_n} % Dummy figure, real figure in process
...
%				\begin{subfigure}[b]{0.32\textwidth}
%                \centering
%                \includegraphics[trim = 20mm 15mm 20mm 20mm,clip,width=\textwidth]{400x400_FD_ESBGK_z}
%                \caption{Fugacity contour in a $400\times400$ grid ; ES model and $\it{b=0.5}$ (FD).}
%                \label{fig:400x400_FD_ESBGK_z}
%        \end{subfigure}%
